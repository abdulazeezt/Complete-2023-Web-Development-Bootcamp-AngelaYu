...
tempstr = "Printing from inside loop <br>"

// var tempstr = document.querySelector("p").getAttribute
...
function getTagClass(tagname) {
  ...
  return temparr  
    ...
    mainpara1.innerHTML = "Returning ID Array : <br> " +getTagID("a")
